...
[![R-CMD-check](https://github.com/JavierDeLaHoze/LDAShiny/workflows/R-CMD-check/badge.svg)](https://github.com/JavierDeLaHoze/LDAShiny/actions)
<!-- badges: end -->
...
You can install the released version of LDAShiny from [CRAN](https://CRAN.R-project.org) with:
