...
shinydashboardPlus::dashboardPagePlus(skin ="blue",
    ...
    #dashboardHeader##########################
    shinydashboardPlus::dashboardHeaderPlus(title = "LDAShiny",
                                            titleWidth = 400,
    ...
    shinydashboard::dashboardBody(tags$head(
        ...
        tabItems(tabItem(
            ...
            box(width = 400,
                ...
                solidHeader = TRUE,
                collapsible = TRUE,
                shiny::sidebarPanel(shinyjs::useShinyjs(),
                   ...
                   fileInput("file","Choose CSV File",
                    ...
                    shiny::checkboxInput(inputId = 'header',
                                         label = 'Header',
                                         value = TRUE),
                    shiny::checkboxInput(inputId = "stringAsFactors",
...
shinyWidgets::awesomeRadio(
                    ...
                    shinyWidgets::awesomeCheckbox(inputId = "removenumber",
                                                  label = "Remove number",
                                                  value = TRUE,
                                                  status = "danger"),
                     pickerInput(
                      ...
                      choices = c("da","nl","en", "fi",
                                 ...
                                 "ru" ,  "es" ,   "sv"),
                      choicesOpt = list(
                        subtext = paste(Languages <- c("danish","dutch","english", "finnish",
                    ...
                    div(style="display: inline-block;vertical-align:top; width: 200px;",
                        selectInput("Stemm", " Stemming langauge",
                                    choices = c("porter","danish","dutch","english", "finnish",
                                                "french" ,    "german"    , "hungarian" , "italian",
                                                 "norwegian", "portuguese", "romanian" ,
                                                 "russian" ,   "spanish" ,   "swedish")
                                    )
                    ...
                    #shinyjs::hidden(
                      div(id = "dTm",
                          ...
                          shinyWidgets::actionBttn(inputId = "dtm.update",
                                                   label = "Create DTM",
                                                   style = "float",
                                                   block = TRUE,
                                                   color="primary")
                      ),
                    bsModalNoClose(id = "DTMdim",
                                   title = "dim DTM",
                                   trigger = "dTm",
                                   size="large",
                ...
                mainPanel(
                   ...
                   box(width = 350,
                       ...
                       div(id = "data_b",
                           style="display:inline-block",
                            shinyWidgets::actionBttn(inputId = "data",
                                                     label = "View Data",
                                                     icon=icon('table'),
                                                     style = "float",
                                                     block = TRUE,
                       ...
                       div(id = "plot_b",
                           style="display:inline-block",
                             shinyWidgets::actionBttn(inputId ="plot",
                                                      label = "View barplot",
                                                      icon=icon("bar-chart"),
                                                      style = "float",
                                                      block = TRUE,
                       ...
                       bsModalNoClose(id= "Plot", title = "Barplot", trigger = "plot", size="large",
                ...
                box (title = "3. Number of topic",
                  ...
                  tabBox(width = 300,
                       ...
                       tabPanel("Coherence",
                         ...
                         textInput(inputId = "OtherKCoherence",
                                   label = "Others K",
                                   value = paste(exp.stop, collapse = ", "),
                         ...
                         div(style="display: inline-block;vertical-align:top; width: 110px;",
                             numericInput(inputId = "num5",
                                          label = "Burn-in",
                                          value = 5,
                                          min = 5)
                             ),
                         shinyBS::bsPopover(id = "num5",
                       ...
                       tabPanel("4-metrics",
                                ...
                                div(style="display: inline-block;vertical-align:top; width: 120px;",
                                 numericInput(inputId = "num7",
                                              label = "from",
                                              value = 2,
                                              min = 2)
                                 ),
                                div(style="display: inline-block;vertical-align:top; width: 120px;",
                                    numericInput(inputId = "num8",
                                                 label = "to",
                                                 value = 2,
                                                 min = 2)
                                    ),
                                div(style="display: inline-block;vertical-align:top; width: 110px;",
                                    numericInput(inputId = "num9",
                                                 label = "by",
                                                 value = 1,
                                                 min = 1)
                                    ),
                                    textInput(inputId = "OtherK4metric",
                                              label = "Others K",
                                             value = paste(exp.stop, collapse = ", "),
                                                           placeholder = "Enter values separated by a comma...50, 100, 150,..."),
                       ...
                       tabPanel("Perplexity",
                                shiny::sidebarPanel(width = 300,
                                 ...
                                 div(style="display: inline-block;vertical-align:top; width: 120px;",
                                                    numericInput(inputId = "num14",
                                                                 label = "to",
                                                                 value = 5,
                                                                 min = 2)
                                     ),
                                div(style="display: inline-block;vertical-align:top; width: 110px;",
                                                     numericInput(inputId = "num15",
                                                                  label = "by",
                                                                  value = 2,
                                                                  min = 1)
                                    ),
                                textInput(inputId = "OtherKLL",
                                          label = "Others K",
                                ...
                                helpText(h3("Parameters control Gibbs sampling")),
                                div(style="display: inline-block;vertical-align:top; width: 110px;",
                                    numericInput(inputId = "num16",
                                                 label = "Iteractions",
                                                 value = 10,
                                                 min = 10)
                                    ),
                                div(style="display: inline-block;vertical-align:top; width: 110px;",
                                    numericInput(inputId = "num17",
                                                 label = "Burn-in",
                                                 value = 5,
                                                 min = 5)
                                    ),
                                div(style="display: inline-block;vertical-align:top; width: 110px;",
                                    numericInput(inputId = "num18",
                                                 label = "Thin",
                                                 value = 3,
                                                 min = 3)
                                    ),
...
bsModalNoClose(id= "harmonic",
        ...
        tabItem(tabName = "tab42",
                box(width = 400,
                    ...
                    solidHeader = TRUE,
                    collapsible = TRUE,
                    div(id = "data_theta",style="display:inline-block",
                        shinyWidgets::actionBttn("datatheta",
                                                 "theta",
                                                 icon=icon('table'),
                                                 style = "float", block = TRUE,color="primary")
                        ),
                    bsModalNoClose(id="datathet",
                                   title = "theta",
                                   trigger = "data_theta",
                                   size="large",
                    ...
                    bsModalNoClose(id="SummLDA",
                                   title = "Summary",
                                   trigger = "summ_LDA",
                                   size="large",
                            sliderInput(inputId = "Topterm",
                            ...
                            sliderInput(inputId = "Labels",
                                        ...
                                        value = 1,
                                        step = 1),
                            sliderInput(inputId = "assignments",
...
bsModalNoClose(id= "plotworcloud",
               title = "Wordcloud",
               trigger = "plot_cloud",
               size="large",
...
div(id = "heatmap",
    style="display:inline-block",
        ...
        tabItem(tabName = "tab5",
                shiny::fluidPage(tabBox(title = "",
                                        ...
                                        tabPanel("Español", tags$iframe(src = 'Una_breve_introducci-n_a_LDAShiny.html',
                                                                        width = '100%',
                                                                        height = '1000px',
                                                                        frameborder = 0,
                                                                        scrolling = 'auto'
    ...
    shinydashboardPlus::rightSidebar( tags$button(
        id = 'close',
        type = "button",
